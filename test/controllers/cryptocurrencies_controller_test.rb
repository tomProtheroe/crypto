...
class CryptocurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cryptocurrency" do
    assert_difference('Cryptocurrency.count') do
      post cryptocurrencies_url, params: { cryptocurrency: { amount: @cryptocurrency.amount, cost_per: @cryptocurrency.cost_per, symbol: @cryptocurrency.symbol, user_id: @cryptocurrency.user_id } }
    end
  ...
  test "should update cryptocurrency" do
    patch cryptocurrency_url(@cryptocurrency), params: { cryptocurrency: { amount: @cryptocurrency.amount, cost_per: @cryptocurrency.cost_per, symbol: @cryptocurrency.symbol, user_id: @cryptocurrency.user_id } }
